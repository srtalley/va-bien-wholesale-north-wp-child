...
<div class="bc-container">
	...
	<div class="bc-row">
		...
		<div class="bc-col-2">
			...
			<input type="text" name="band_size" id="band_size" value="" placeholder="Size in Inches">
		...
		<div class="bc-col-2">
			...
			<input type="text" name="bust_size" id="bust_size" value="" placeholder="Size in Inches">
